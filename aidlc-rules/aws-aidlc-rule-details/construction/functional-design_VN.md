...
**Thiết kế logic nghiệp vụ chi tiết theo từng đơn vị**
...
- Quy tắc nghiệp vụ chi tiết, logic xác thực, và các ràng buộc
- Thiết kế không phụ thuộc công nghệ (không quan tâm cơ sở hạ tầng)

**Lưu ý**: Điều này xây dựng dựa trên thiết kế thành phần cấp cao từ Thiết kế Ứng dụng (Giai đoạn KHỞI TẠO)

## Điều kiện Tiên quyết

- Tạo Đơn vị phải hoàn thành
- Artifact đơn vị công việc phải có sẵn
- Thiết kế Ứng dụng được khuyến nghị (cung cấp cấu trúc thành phần cấp cao)
- Kế hoạch thực hiện phải chỉ ra giai đoạn Thiết kế Chức năng nên thực thi

## Tổng quan

Thiết kế logic nghiệp vụ chi tiết cho đơn vị, không phụ thuộc công nghệ và tập trung thuần túy vào các chức năng nghiệp vụ.
...
- Hiểu trách nhiệm và ranh giới đơn vị

### Bước 2: Tạo Kế hoạch Thiết kế Chức năng

- Tạo kế hoạch với các checkbox [] cho thiết kế chức năng
...
**CHỈ THỊ**: Phân tích kỹ lưỡng định nghĩa đơn vị và các artifact thiết kế chức năng để xác định TẤT CẢ các khu vực mà sự làm rõ sẽ cải thiện thiết kế chức năng. Hãy chủ động trong việc đặt câu hỏi để đảm bảo hiểu biết toàn diện.

**QUAN TRỌNG**: Mặc định đặt câu hỏi khi có BẤT KỲ sự mơ hồ hoặc thiếu chi tiết nào có thể ảnh hưởng đến chất lượng thiết kế chức năng. Thà hỏi quá nhiều câu hỏi còn hơn là đưa ra các giả định sai lầm.
...
- Tạo câu hỏi bất cứ nơi nào đầu vào của người dùng sẽ cải thiện các quyết định thiết kế chức năng
- **Khi nghi ngờ, hãy đặt câu hỏi** - sự quá tự tin dẫn đến các thiết kế kém

**Các danh mục câu hỏi cần xem xét** (đánh giá TẤT CẢ các danh mục):
...
- **Luồng Dữ liệu** - Hỏi về đầu vào, đầu ra, chuyển đổi, và yêu cầu lưu trữ dữ liệu
- **Điểm Tích hợp** - Hỏi về tương tác hệ thống bên ngoài, API, và trao đổi dữ liệu
- **Xử lý Lỗi** - Hỏi về kịch bản lỗi, lỗi xác thực, và xử lý ngoại lệ
...
- Tìm kiếm các phản hồi như "phụ thuộc", "có thể", "không chắc", "kết hợp của", "đâu đó giữa"
...
```
     ...
     2. **Tóm tắt AI** (tùy chọn): Cung cấp tóm tắt gạch đầu dòng có cấu trúc về thiết kế chức năng
...
- Không tiếp tục cho đến khi người dùng phê duyệt rõ ràng thiết kế chức năng
...
- Đánh dấu giai đoạn Thiết kế Chức năng hoàn thành trong aidlc-state.md
