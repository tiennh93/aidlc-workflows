...
**Smart Suggestions**:
- **Shared databases/storage** → "Critical dependency - recommend coordination"
- **Message queues/events** → "Can proceed with adapter pattern"
- **API gateways/load balancers** → "Standard patterns available, can proceed"
- **Network infrastructure** → "Integration patterns affect infrastructure design"

### Step 2: Analyze Design Artifacts
...
### Step 3: Create Infrastructure Design Plan
...
### Step 7: Generate Infrastructure Design Artifacts
