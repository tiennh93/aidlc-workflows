...
- **Security requirements** → "Critical dependency - recommend coordination"
- **Shared NFR constraints** → "Consider team coordination"

### Step 2: Analyze Functional Design
...
### Step 3: Create NFR Requirements Plan
